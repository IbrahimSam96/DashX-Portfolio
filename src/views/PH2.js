...
class PH2 extends Component {
  ...
  <Navbar >
      ...
      <NavLink exact to= "/Securities/Equity"> <Navbar.Brand  style={{color:"white", fontSize:"1.0em", borderBottom:"0.1em solid white"}}> <b>Equity</b></Navbar.Brand></NavLink>
...
const columns = [
   ...
   const getMuiTheme = () => createMuiTheme({
    ...
    for(const v in Gandu.default) {
        ...
        z["Exp_Net"] = Gandu.default[v].Exp_Net[Gandu.default[v].Exp_Net.length -1]
