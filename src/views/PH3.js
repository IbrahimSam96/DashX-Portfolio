...
class PH3 extends Component {
  ...
  <Navbar >
      ...
      <NavLink exact to= "/Securities/Futures"> <Navbar.Brand  style={{color:"white", fontSize:"1.0em", borderBottom:"0.1em solid white"}}> <b>Futures</b></Navbar.Brand></NavLink>
...
const columns = [
   ...
   const getMuiTheme = () => createMuiTheme({
    ...
    for(const v in Gandu.default){
        ...
        z["category"] = Gandu.default[v].Sector
